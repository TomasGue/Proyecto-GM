...
public class PantallaMenu implements Screen {
    ...
    private void drawButtons() {
        ...
        batch.setColor(jugarHover ? Color.LIGHT_GRAY : Color.DARK_GRAY);
        ...
        // Usar la nueva fuente para el texto "JUGAR"
        ...
        // Usar la nueva fuente para el texto "SALIR"
...
public class PantallaMenu implements Screen {
    ...
    public PantallaMenu(SpaceNavigation game) {
        ...
        // Cargar la nueva fuente para el título
        titleFont = new BitmapFont(Gdx.files.internal("fond.fnt"));
    ...
    private void drawTitle() {
        ...
        // Ajustar la escala para agrandar el título
        titleFont.getData().setScale(2f); // Cambia este valor para ajustar el tamaño, 2f es el doble del tamaño original

        // Dibujar el título en la nueva fuente
        layout.setText(titleFont, "SpaceDemons");
        float titleX = (1200 - layout.width) / 2;
        float titleY = 700;
        titleFont.draw(batch, layout, titleX, titleY);
    ...
    public void dispose() {
        ...
        ringPlanet.dispose();
        buttonBackground.dispose();
        titleFont.dispose(); // Liberar la fuente del título
    }
